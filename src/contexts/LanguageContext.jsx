...
export const translations = {
    pt: {
        ...
        projects: {
            ...
            newdawn: {
                title: 'New dawn',
                description: 'New Dawn é uma plataforma whitelist voltada para o agendamento de barbearias. Ela oferece um painel administrativo centralizado, que permite o gerenciamento unificado de todas as barbearias cadastradas. Cada barbearia, por sua vez, conta com seu próprio domínio personalizado e estilo visual exclusivo (CSS customizado), garantindo identidade e autonomia dentro do ecossistema da plataforma.'
            },
            saldonegativo: {
